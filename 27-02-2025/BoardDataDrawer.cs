...
public class BoardDataDrawer : Editor
{
      ...
      private ReordableList _dataList;
    ...
    private void InitializeReordableList(ref ReordableList dataList, string v1, string v2)
    {
    ...
    public override void OnInspectorGUI()
      ...
      private void InitializeReordableList(ref ReordableList list,
                                             string propertyName,
                                             string listLabel)
      {
